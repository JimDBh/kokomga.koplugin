...
5. [**Reading Progress Synchronization & Next Chapter Flow**](Reading-Progress-Synchronization.md)
   Discover how background progress sync, native KOReader `kosync` interception, auto-RTL, and the next-chapter end-of-book flows keep your reading state perfectly aligned.
...
* **`core/sync.lua`**: Handles book matching (hierarchical filename and parent directory matching), progress synchronization (pull/push), and the auto-load next chapter flow.
