...
* **Bookshelf Integration**: Add Komga shelves—recently read or added series and books—to the [Bookshelf](https://github.com/AndyHazz/bookshelf.koplugin) home screen and download books straight from them.
